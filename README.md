...
- Timestamp: `2022-06-01 11:47`
- Build ID: `14aff7a2-7b7d-431c-895a-35aaf86a4d4e`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/14aff7a2-7b7d-431c-895a-35aaf86a4d4e.git
$ cd 14aff7a2-7b7d-431c-895a-35aaf86a4d4e
```
